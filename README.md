...
- [x] Release GF Dataset (we will continue to expand it).
- [ ] Release a lightweight version (i.e., GFRRN_s).
...
Download [GFRRN.pt](https://huggingface.co/tabe-i/GFRRN_weight/tree/main), [GFRRN_s.pt]() and [swin_large_o365_finetune.pth](https://huggingface.co/tabe-i/GFRRN_weight/tree/main). Put them in ```weights``` folder. Download datasets ([Google Drive](https://drive.google.com/file/d/1hFZItZAzAt-LnfNj-2phBRwqplDUasQy/view?usp=sharing) or [Baidu Disk](https://pan.baidu.com/s/15zlk5o_-kx3ruKj4KfOvtA?pwd=1231)) and put them in ```datasets``` folder.
