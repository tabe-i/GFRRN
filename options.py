...
class SIRSOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--arch', type=str, default='gfrrn',
        ...
        self.parser.add_argument('--model', type=str, default='gfrrn_model_sirs_lrm', help='chooses which model to use.')
        ...
        # training settings
        self.parser.add_argument('--seed', type=int, default=2024, help='random seed to use. Default=0')
        ...
        self.parser.add_argument('--data_separate', type=str, default='gaussian', help='method to separate R')
        self.parser.add_argument('--high_polish', type=int, default=0, help='polish flag')
        ...
        self.parser.add_argument('--lambda_vgg', type=float, default=0.01, help='weight for vgg loss')
        self.parser.add_argument('--lamda_high_residual', type=float, default=0.3, help='weight for r_high loss')
